...
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `nr_inscrieri`) VALUES (1,6,'Activitate de studiu pentru Fizica','2024-12-28','2024-12-26','19:00:58','01:00:00','10:00:00','02:00:00',5,5),(2,7,'Activitate de studiu pentru Engleza','2024-12-30','2024-12-26','19:01:03','01:00:00','12:00:00','01:00:00',5,2),(3,6,'Activitate de studiu pentru Fizica','2024-12-28','2024-12-26','19:01:09','01:00:00','10:00:00','02:00:00',5,0),(4,7,'Activitate de studiu pentru Engleza','2024-12-30','2024-12-26','19:01:13','01:00:00','12:00:00','02:00:00',5,0);
...
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (1,88,1,'2024-12-26'),(2,93,1,'2024-12-26'),(3,91,1,'2024-12-26'),(4,90,1,'2024-12-26'),(5,87,1,'2024-12-26'),(6,92,2,'2024-12-26'),(7,91,2,'2024-12-26');
...
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`) VALUES (1,6,93,'Salut!','2024-12-26'),(2,6,92,'Hello!','2024-12-26'),(3,6,93,'Salut!','2024-12-26'),(4,6,92,'Hello!','2024-12-26'),(5,6,90,'Ce faceti?','2024-12-26');
...
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (1,92,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2024-12-26 19:03:05'),(2,91,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2024-12-26 19:03:05');
...
BEGIN
    ...
    WHERE descriere = p_descriere_activitate
      AND data_activitate >= CURDATE()  -- Activitățile viitoare (opțional)
    LIMIT 1;
    ...
    IF v_count > 0 THEN
        ...
        IF NOT EXISTS (
            ...
            -- Mesaj de succes
            SELECT 'Studentul a fost înscris cu succes la activitatea de studiu.' AS mesaj;
        ELSE
...
-- Dump completed on 2024-12-26 19:23:24
