...
CREATE TABLE `inscrieri` (
  ...
  KEY `inscrieri_discipline_disciplina_id_fk` (`disciplina_id`),
  CONSTRAINT `inscrieri_discipline_disciplina_id_fk` FOREIGN KEY (`disciplina_id`) REFERENCES `discipline` (`disciplina_id`),
...
CREATE TABLE `profesori_discipline` (
  ...
  KEY `profesori_discipline_discipline_disciplina_id_fk` (`disciplina_id`),
  CONSTRAINT `profesori_discipline_discipline_disciplina_id_fk` FOREIGN KEY (`disciplina_id`) REFERENCES `discipline` (`disciplina_id`),
...
-- Dump completed on 2024-12-09 22:44:51
