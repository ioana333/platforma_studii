...
INSERT INTO `activitati_grupe_de_studiu` VALUES (1,6,'Activitate de studiu pentru Fizica','2025-04-28','2025-01-08','19:51:05','01:00:00','10:00:00','02:00:00',5,NULL,8);
...
INSERT INTO `inscrieri_activitati_grupe_studiu` VALUES (1,88,1,'2025-01-08'),(2,93,1,'2025-01-08'),(3,91,1,'2025-01-08'),(4,90,1,'2025-01-08'),(5,87,1,'2025-01-08'),(6,92,1,'2025-01-08'),(7,74,1,'2025-01-08'),(8,85,1,'2025-01-08');
...
INSERT INTO `mesaje` VALUES (1,6,93,'Salut!','2025-01-08'),(2,6,92,'Hello!','2025-01-08'),(3,6,93,'Salut!','2025-01-08'),(4,6,92,'Hello!','2025-01-08'),(5,6,90,'Ce faceti?','2025-01-08');
...
INSERT INTO `mesaje_private` VALUES (1,92,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-08 19:52:51'),(2,91,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-08 19:52:51'),(4,92,'Activitatea \"Activitate de studiu pentru Engleza\" a fost anulata.','2025-01-09 18:18:24'),(5,91,'Activitatea \"Activitate de studiu pentru Engleza\" a fost anulata.','2025-01-09 18:18:24');
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `VerificaActivitatiPeriodice` ON SCHEDULE EVERY 1 MINUTE STARTS '2025-01-08 19:50:51' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sugesti_de_participanti`(
    IN p_activitate_id INT,        -- ID-ul activității inițiate
    IN p_student_initiator_id INT -- ID-ul studentului care inițiază activitatea
)
BEGIN
    DECLARE v_grupa_id INT;

    -- Obținem ID-ul grupei de studiu pe baza activității
    SELECT grupa_id INTO v_grupa_id
    FROM activitati_grupe_de_studiu
    WHERE activitate_id = p_activitate_id
    LIMIT 1;

    -- Verificăm dacă grupa există
    IF v_grupa_id IS NULL THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Grupa pentru activitatea specificată nu a fost găsită.';
    END IF;
...
-- Dump completed on 2025-01-09 19:15:40
