...
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `profesor_id`, `nr_inscrieri`) VALUES (1,6,'Activitate de studiu pentru Fizica','2025-04-28','2025-01-12','14:11:43','01:00:00','10:00:00','02:00:00',5,NULL,8);
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `profesor_id`, `nr_inscrieri`) VALUES (4,7,'Pregatire examen Engleza','2025-01-17','2025-01-12','14:11:43','01:00:00','16:00:00','02:00:00',5,NULL,6);
...
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (1,6,93,'Salut!','2025-01-12','14:11:43');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (2,6,92,'Hello!','2025-01-12','14:11:43');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (3,6,90,'Ce faceti?','2025-01-12','14:11:43');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (4,6,93,'Ati invatat pentru testul de maine?','2025-01-12','14:11:43');
...
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (1,92,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-12 14:13:21');
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (2,91,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-12 14:13:21');
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (4,92,'Activitatea \"Activitate de studiu pentru Engleza\" a fost anulata.','2025-01-12 15:12:21');
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (5,91,'Activitatea \"Activitate de studiu pentru Engleza\" a fost anulata.','2025-01-12 15:12:21');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `afisare_studenti_cur` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `afisare_studenti_cur`(IN numeDisciplina VARCHAR(100))
BEGIN
...
-- Dump completed on 2025-01-12 18:25:19
