...
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `profesor_id`, `nr_inscrieri`) VALUES (1,6,'Activitate de studiu pentru Fizica','2025-04-28','2025-01-12','23:52:12','01:00:00','10:00:00','02:00:00',5,NULL,8);
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `profesor_id`, `nr_inscrieri`) VALUES (2,7,'Activitate de studiu pentru Engleza','2025-04-30','2025-01-12','23:52:15','01:00:00','12:00:00','02:00:00',5,NULL,2);
INSERT INTO `activitati_grupe_de_studiu` (`activitate_id`, `grupa_id`, `descriere`, `data_activitate`, `data_postare`, `timp_postare`, `timp_expirare`, `ora`, `durata`, `min_participanti`, `profesor_id`, `nr_inscrieri`) VALUES (4,7,'Pregatire examen Engleza','2025-01-17','2025-01-12','23:52:17','01:00:00','16:00:00','02:00:00',5,NULL,6);
...
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (1,88,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (2,93,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (3,91,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (4,90,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (5,87,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (6,92,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (7,74,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (8,85,1,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (9,92,2,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (10,91,2,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (13,91,4,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (14,94,4,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (15,62,4,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (16,61,4,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (17,84,4,'2025-01-12');
INSERT INTO `inscrieri_activitati_grupe_studiu` (`id`, `student_id`, `activitate_id`, `data_inscriere`) VALUES (18,74,4,'2025-01-12');
...
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (1,6,93,'Salut!','2025-01-12','23:52:20');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (2,6,92,'Hello!','2025-01-12','23:52:20');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (3,6,90,'Ce faceti?','2025-01-12','23:52:20');
INSERT INTO `mesaje` (`id`, `grupa_id`, `student_id`, `continut`, `data_trimitere`, `ora_trimitere`) VALUES (4,6,93,'Ati invatat pentru testul de maine?','2025-01-12','23:52:20');
...
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (1,92,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-12 23:53:18');
INSERT INTO `mesaje_private` (`id`, `student_id`, `continut`, `data_trimitere`) VALUES (2,91,'Activitatea \"Activitate de studiu pentru Engleza2\" a fost anulata.','2025-01-12 23:53:18');
...
BEGIN
    -- Afișăm toate activitățile la care studentul nu este înscris
    SELECT
        g.nume_grupa,
        a.descriere,
        a.data_activitate,
    ...
    LEFT JOIN inscrieri_activitati_grupe_studiu i ON a.activitate_id = i.activitate_id AND i.student_id = p_student_id
    WHERE m.student_id = p_student_id
      AND a.data_activitate >= CURDATE()
      AND i.activitate_id IS NULL -- Condiție pentru a exclude activitățile la care studentul este deja înscris
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `inscriere_activitate_studiu`(
    IN p_id_student INT,
    IN p_descriere_activitate TEXT
)
BEGIN
    ...
    -- Obținem ID-ul activității și ID-ul grupei asociate pe baza descrierii activității
    SELECT a.activitate_id, a.grupa_id
    INTO v_id_activitate, v_id_grupa
    FROM activitati_grupe_de_studiu a
    WHERE a.descriere = p_descriere_activitate
      AND a.data_activitate >= CURDATE()  -- Activitățile viitoare
    LIMIT 1;
    ...
    WHERE m.student_id = p_id_student
      AND m.grupa_id = v_id_grupa;
    ...
    IF v_count > 0 THEN
        ...
        IF NOT EXISTS (
            ...
            -- Actualizăm numărul de înscrieri pentru activitatea respectivă
            UPDATE activitati_grupe_de_studiu
            SET nr_inscrieri = nr_inscrieri + 1
            WHERE activitate_id = v_id_activitate;

            -- Mesaj de succes
            SELECT 'Studentul a fost înscris cu succes.' AS mesaj;
        ELSE
    ...
    ELSE
        ...
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Studentul nu face parte din grupa asociată activității.';
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2025-01-12 23:53:49
