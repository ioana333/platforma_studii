...
public class VizualizareStudentiController {
    ...
    public void loadMembrii(String disciplina) {

        disciplina_grupa.setText("Studentii inscrisi la " + disciplina);
        ...
        try
        {
            ...
            preparedStatement = conection.prepareStatement("call afisare_studenti_curs(?)");
            preparedStatement.setString(1, disciplina);
